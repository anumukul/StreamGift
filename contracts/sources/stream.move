module streamgift::stream {
    ...
    public entry fun cancel_stream(
        ...
        if (claimable > 0) {
            ...
            coin::deposit(stream.recipient, recipient_payment);
        };
    ...
    public entry fun withdraw_fees(
        ...
        assert!(admin_addr == contract_address, error::permission_denied(E_NOT_STREAM_SENDER));
